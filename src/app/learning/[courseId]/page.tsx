      ...
      try {
        ...
        if (course) {
          ...
          const allLessons = course?.modules?.flatMap((module: any) => 
            ...
            try {
              const completedQuizzesResponse = await fetch(`${process.env.NEXT_PUBLIC_API_URL || 'https://cybertest-frontend-production.up.railway.app'}/api/progress/completed-quizzes`, {
                headers: {
            ...
            if (token) {
              try {
                const quizzesResponse = await fetch(`${process.env.NEXT_PUBLIC_API_URL || 'https://cybertest-frontend-production.up.railway.app'}/api/progress/course/${courseId}/quizzes`, {
                  headers: {
